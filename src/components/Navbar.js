        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4 text-slate-200">
            ...
            <div className="hidden md:flex items-center gap-3 pl-2 border-l border-slate-700 ml-2">
              {user ? (
                <>
                  <Link to="/orders" className="flex items-center gap-2 hover:text-white transition-colors">
            ...
            <div className="space-y-2">
              {user ? (
                <>
                  ...
                  <Link to="/orders" className="block p-2 text-slate-300 hover:bg-slate-800 rounded">Siparişlerim</Link>
